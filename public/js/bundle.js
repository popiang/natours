...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoicG9waWFuZyIsImEiOiJjbGMyMjBtbngzbG9sM25xbnZyeHduamJ3In0.yNlj-XV06jZlyZAKWMlwgg';
  ...
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(tourId) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          stripe = Stripe('pk_test_51MNxwfCljId4phulhz2JA5J3A1Pfbg6KVNJqbjJpT7wIzeEKBgrPiXaLhAZPacp7ynEbFpfp2yYbLPt80gBt49xl006KgmQpaw'); // get the checkout session from API
          _context.next = 4;
